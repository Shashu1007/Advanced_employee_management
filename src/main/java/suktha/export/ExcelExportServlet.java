    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (idsParam != null && !idsParam.isEmpty()) {
                ...
                String[] idsArray = new String[idArray.length];
                for (int i = 0; i < idArray.length; i++) {
                    String ids = idArray[i].replaceAll("[\\[\\]\"]", ""); // Remove square brackets and double quotes
                    idsArray[i] = ids;
                }

                for (String idstr : idsArray) {
                    System.out.println("IDs Array: " + idstr);
                } // Print parameter value for debugging
